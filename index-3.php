...
<!-- Mirrored from templates.hibootstrap.com/ecop/default/index-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 30 Jun 2022 10:36:35 GMT -->
...
<body>
            ...
            <div class="row">
                <div class="col-sm-3 col-lg-2">
                    <div class="video-left">
                        <form>
                            <div class="form-group">
                                <div class="dropdown">
                                    <button class="btn btn-video-left dropdown-toggle" type="button" id="dropdownMenu2"
                            ...
                            <div class="form-group">
                                <div class="dropdown">
                                    <button class="btn btn-video-left dropdown-toggle" type="button" id="dropdownMenu3"
                                        data-bs-toggle="dropdown" aria-expanded="false">
                            ...
                            <div class="form-group">
                                <div class="dropdown">
                                    <button class="btn btn-video-left dropdown-toggle" type="button" id="dropdownMenu4"
                                        data-bs-toggle="dropdown" aria-expanded="false">
                            ...
                            <div class="form-group">
                                <div class="dropdown">
                                    <button class="btn btn-video-left dropdown-toggle" type="button" id="dropdownMenu5"
                                        data-bs-toggle="dropdown" aria-expanded="false">
                            ...
                            <div class="form-group">
                                <div class="dropdown">
                                    <button class="btn btn-video-left dropdown-toggle" type="button" id="dropdownMenu6"
                                        data-bs-toggle="dropdown" aria-expanded="false">
                            ...
                            <div class="form-group">
                                <div class="dropdown">
                                    <button class="btn btn-video-left dropdown-toggle" type="button" id="dropdownMenu7"
                                        data-bs-toggle="dropdown" aria-expanded="false">
                            ...
                            <div class="form-group">
                                <div class="dropdown">
                                    <button class="btn btn-video-left dropdown-toggle" type="button" id="dropdownMenu8"
                                        data-bs-toggle="dropdown" aria-expanded="false">
                            ...
                            <div class="form-group">
                                <div class="dropdown">
                                    <button class="btn btn-video-left dropdown-toggle" type="button" id="dropdownMenu9"
                                        data-bs-toggle="dropdown" aria-expanded="false">
                ...
                <div class="col-sm-9 col-lg-10">
                    <div class="video-slider owl-theme owl-carousel">
                        <div class="video-item video-bg-one">
                            <div class="d-table">
                                <div class="d-table-cell">
                                    <div class="inner">
                                        <div class="video-wrap">
                                            <button class="js-modal-btn" data-video-id="nZIIfNX_mb0">
                                                <i class='bx bx-play'></i>
                                            </button>
                                        </div>
                                        <h3>See How We Collect Raw Vegetable For You</h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="d-table">
                                <div class="d-table-cell">
                                    <div class="inner-two">
                                        ...
                                        <a class="common-btn three" href="shop.html">
                                            Shop Now
                        ...
                        <div class="video-item video-bg-three">
                            <div class="d-table">
                                <div class="d-table-cell">
                                    <div class="inner">
                                        <div class="video-wrap">
                    ...
                    <div class="products-area three pb-100">
                            ...
                            <div class="col-sm-6 col-lg-3">
                                <div class="products-item">
                                    <div class="top">
                                        ...
                                        <img src="assets/images/products/products26.png" alt="Products">
                                        <div class="inner">
                                            <h3>
                                                <a href="single-product.html">Cauliflower - 1ps</a>
                                            </h3>
                                            <span>$11.00</span>
                                        </div>
                                    </div>
                                    <div class="bottom">
                                        <a class="cart-text cart1" href="#">Add To Cart</a>
                            ...
                            <div class="col-sm-6 col-lg-3">
                                <div class="products-item">
                                    <div class="top">
                                        ...
                                        <img src="assets/images/products/products27.png" alt="Products">
                                        <div class="inner">
                                            <h3>
                                                <a href="single-product.html">Carrot - 1 kg</a>
                                            </h3>
                                            <span>$18.00</span>
                                        </div>
                                    </div>
                                    <div class="bottom">
                                        <a class="cart-text cart2" href="#">Add To Cart</a>
                                        <i class='bx bx-plus'></i>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6 col-lg-3">
                                <div class="products-item">
                                    <div class="top">
                                        ...
                                        <img src="assets/images/products/products28.png" alt="Products">
                                        <div class="inner">
                                            <h3>
                                                <a href="single-product.html">Cabbage - 1 ps</a>
                                            </h3>
                                            <span>$19.00</span>
                                        </div>
                                    </div>
                                    <div class="bottom">
                                        <a class="cart-text cart3" href="#">Add To Cart</a>
                                        <i class='bx bx-plus'></i>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6 col-lg-3">
                                <div class="products-item">
                                    <div class="top">
                                        ...
                                        <img src="assets/images/products/products29.png" alt="Products">
                                        <div class="inner">
                                            <h3>
                                                <a href="single-product.html">Capsicum</a>
                                            </h3>
                                            <span>$180.00</span>
                                        </div>
                                    </div>
                                    <div class="bottom">
                                        <a class="cart-text cart4" href="#">Add To Cart</a>
                                        <i class='bx bx-plus'></i>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6 col-lg-3">
                                <div class="products-item">
                                    <div class="top">
                                        ...
                                        <img src="assets/images/products/products30.png" alt="Products">
                                        <div class="inner">
                                            <h3>
                                                <a href="single-product.html">Blue Grape - 1 kg</a>
                                            </h3>
                                            <span>$11.00</span>
                                        </div>
                                    </div>
                                    <div class="bottom">
                                        <a class="cart-text cart5" href="#">Add To Cart</a>
                                        <i class='bx bx-plus'></i>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6 col-lg-3">
                                <div class="products-item">
                                    <div class="top">
                                        ...
                                        <img src="assets/images/products/products31.png" alt="Products">
                                        <div class="inner">
                                            <h3>
                                                <a href="single-product.html">Strawberry - 1 kg</a>
                                            </h3>
                                            <span>$18.00</span>
                                        </div>
                                    </div>
                                    <div class="bottom">
                                        <a class="cart-text cart6" href="#">Add To Cart</a>
                                        <i class='bx bx-plus'></i>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6 col-lg-3">
                                <div class="products-item">
                                    <div class="top">
                                        ...
                                        <img src="assets/images/products/products32.png" alt="Products">
                                        <div class="inner">
                                            <h3>
                                                <a href="single-product.html">Red Pepper - 1 kg</a>
                                            </h3>
                                            <span>$10.00</span>
                                        </div>
                                    </div>
                                    <div class="bottom">
                                        <a class="cart-text cart7" href="#">Add To Cart</a>
                                        <i class='bx bx-plus'></i>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6 col-lg-3">
                                <div class="products-item">
                                    <div class="top">
                                        ...
                                        <img src="assets/images/products/products33.png" alt="Products">
                                        <div class="inner">
                                            <h3>
                                                <a href="single-product.html">Red Orange - 1 kg</a>
                                            </h3>
                                            <span>$21.00</span>
                                        </div>
                                    </div>
                                    <div class="bottom">
                                        <a class="cart-text cart8" href="#">Add To Cart</a>
                                        <i class='bx bx-plus'></i>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6 col-lg-3">
                                <div class="products-item">
                                    <div class="top">
                                        ...
                                        <img src="assets/images/products/products34.png" alt="Products">
                                        <div class="inner">
                                            <h3>
                                                <a href="single-product.html">Salmon Filet - 1 kg</a>
                                            </h3>
                                            <span>$52.00</span>
                                        </div>
                                    </div>
                                    <div class="bottom">
                                        <a class="cart-text cart9" href="#">Add To Cart</a>
                                        <i class='bx bx-plus'></i>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6 col-lg-3">
                                <div class="products-item">
                                    <div class="top">
                                        ...
                                        <img src="assets/images/products/products35.png" alt="Products">
                                        <div class="inner">
                                            <h3>
                                                <a href="single-product.html">Leg Piece - 1 kg</a>
                                            </h3>
                                            <span>$48.00</span>
                                        </div>
                                    </div>
                                    <div class="bottom">
                                        <a class="cart-text cart10" href="#">Add To Cart</a>
                                        <i class='bx bx-plus'></i>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6 col-lg-3">
                                <div class="products-item">
                                    <div class="top">
                                        ...
                                        <img src="assets/images/products/products36.png" alt="Products">
                                        <div class="inner">
                                            <h3>
                                                <a href="single-product.html">Beef Steak - 1 kg</a>
                                            </h3>
                                            <span>$80.00</span>
                                        </div>
                                    </div>
                                    <div class="bottom">
                                        <a class="cart-text cart11" href="#">Add To Cart</a>
                                        <i class='bx bx-plus'></i>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6 col-lg-3">
                                <div class="products-item">
                                    <div class="top">
                                        ...
                                        <img src="assets/images/products/products37.png" alt="Products">
                                        <div class="inner">
                                            <h3>
                                                <a href="single-product.html">Seasonal Lichi - 1 kg</a>
                                            </h3>
                                            <span>$30.00</span>
                                        </div>
                                    </div>
                                    <div class="bottom">
                                        <a class="cart-text cart12" href="#">Add To Cart</a>
                                        <i class='bx bx-plus'></i>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="buy-area three ptb-100">
        <div class="buy-shape">
            <img src="assets/images/shape10.png" alt="Shape">
        </div>
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="buy-img">
                        <img src="assets/images/buy-main3.png" alt="Buy">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="buy-content">
                        <h2>Buy Your Daily Need From Your Home By Our App</h2>
                        <p>Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor
                            invidunt ut labore et dolore magna aliquyam erat</p>
                        <a class="common-btn three buy-btn" href="shop.html">
                            <img src="assets/images/shape1.png" alt="Shape">
                            <img src="assets/images/shape2.png" alt="Shape">
    ...
    <div class="products-area three pt-100 pb-70">
        <div class="container">
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="products-item">
                        <div class="top">
                            ...
                            <img src="assets/images/products/products38.png" alt="Products">
                            <div class="inner">
                                <h3>
                                    <a href="single-product.html">Apple - 1 kg</a>
                                </h3>
                                <span>$11.00</span>
                            </div>
                        </div>
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="products-item">
                        <div class="top">
                            ...
                            <img src="assets/images/products/products39.png" alt="Products">
                            <div class="inner">
                                <h3>
                                    <a href="single-product.html">Pepper - 1 kg</a>
                                </h3>
                                <span>$10.00</span>
                            </div>
                        </div>
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="products-item">
                        <div class="top">
                            ...
                            <img src="assets/images/products/products40.png" alt="Products">
                            <div class="inner">
                                <h3>
                                    <a href="single-product.html">Cord Fish - 1 kg</a>
                                </h3>
                                <span>$31.00</span>
                            </div>
                        </div>
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="products-item">
                        <div class="top">
                            ...
                            <img src="assets/images/products/products41.png" alt="Products">
                            <div class="inner">
                                <h3>
                                    <a href="single-product.html">Watermelon - 1 kg</a>
                                </h3>
                                <span>$25.00</span>
                            </div>
                        </div>
    ...
    <div class="testimonials-area three pb-100">
        <div class="container">
            <div class="section-title">
                <h2>Our Client Testimonials</h2>
            </div>
            <div class="testimonials-wrap">
                <img src="assets/images/shape15.png" alt="Shape">
                <div class="testimonials-slider-two owl-theme owl-carousel">
                    <div class="testimonials-item">
                        <i class="flaticon-quote"></i>
                        <p>Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor
                            invidunt ut labore et dolore magna aliquyam erat, sed diam volu ptua</p>
                        <h3>Adam Smith</h3>
    ...
    <div class="support-area three pt-100 pb-70">
        <div class="support-shape">
            <img src="assets/images/shape11.png" alt="Shape">
            <img src="assets/images/shape12.png" alt="Shape">
        </div>
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-sm-6 col-lg-4">
                    <div class="support-item five">
            ...
            <div class="row justify-content-center">
                <div class="col-sm-6 col-lg-4">
                    <div class="blog-item">
                        ...
                        <div class="bottom">
                            <h3>
                                <a href="blog-details.html">How To Collect Fresh Vegetable From The Market</a>
                            </h3>
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="blog-item">
                        ...
                        <div class="bottom">
                            <h3>
                                <a href="blog-details.html">Farmyard Vegetable Now Cost Less Than The GM Food</a>
                            </h3>
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quia recusandae praesentium
                                dolor atque debitis aspernatur quaerat</p>
                            <a class="blog-btn" href="blog-details.html">
                    ...
                    <div class="blog-item-right">
                        <div class="inner">
                            <ul class="align-items-center">
                                ...
                                <li>
                                    <h3>
                                        <a href="blog-details.html">Which Food Contains The Large Amount Vit</a>
                                    </h3>
                                    <a class="blog-btn" href="blog-details.html">
                                        Read More
                                        <i class='bx bx-plus'></i>
                        ...
                        <div class="inner">
                            <ul class="align-items-center">
                                ...
                                <li>
                                    <h3>
                                        <a href="blog-details.html">Top 10 Best Online Store To Buy Meat</a>
                                    </h3>
                                    <a class="blog-btn" href="blog-details.html">
                                        Read More
                                        <i class='bx bx-plus'></i>
                        ...
                        <div class="inner">
                            <ul class="align-items-center">
                                ...
                                <li>
                                    <h3>
                                        <a href="blog-details.html">How To Keep Safety In Market During Pandemic</a>
                                    </h3>
                                    <a class="blog-btn" href="blog-details.html">
                                        Read More
                                        <i class='bx bx-plus'></i>
                        ...
                        <div class="inner">
                            <ul class="align-items-center">
                                ...
                                <li>
                                    <h3>
                                        <a href="blog-details.html">How Online Shopping Save Time & Energy</a>
                                    </h3>
                                    <a class="blog-btn" href="blog-details.html">
                                        Read More
                                        <i class='bx bx-plus'></i>
    ...
    <footer class="footer-area three pt-100 pb-70">
        <div class="footer-shape">
            <img src="assets/images/shape13.png" alt="Shape">
            <img src="assets/images/shape14.png" alt="Shape">
        </div>
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-sm-6 col-lg-4">
                        ...
                        <div class="footer-logo">
                            ...
                            <ul>
                                ...
                                <li>
                                    ...
                                    <a
                                        href="https://templates.hibootstrap.com/cdn-cgi/l/email-protection#076f626b6b6847626468772964686a"><span
                                            class="__cf_email__"
                                            data-cfemail="f199949d9d9eb194929e81df929e9c">[email&#160;protected]</span></a>
                                    <a
                                        href="https://templates.hibootstrap.com/cdn-cgi/l/email-protection#3d54535b527d585e524d135e5250"><span
                                            class="__cf_email__"
                                            data-cfemail="93fafdf5fcd3f6f0fce3bdf0fcfe">[email&#160;protected]</span></a>
                                </li>
                            </ul>
                        </div>
                    </div>
    ...
    <div class="copyright-area three">
        <div class="container">
            <div class="copyright-item">
                <p>Copyright ©2020 Design & Developed by <a href="https://hibootstrap.com/"
...
<!-- Mirrored from templates.hibootstrap.com/ecop/default/index-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 30 Jun 2022 10:37:33 GMT -->
